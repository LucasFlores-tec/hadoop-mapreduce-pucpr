...
public class Informacao6 {
    ...
    public static class MapperInformacao6 extends Mapper<Object, Text, Text, IntWritable> {
       ...
       @Override
        protected void map(Object chave, Text valor, Context context) throws IOException, InterruptedException {
            ...
            if(valores.length == 10 && ANO.equals(valores[1]) && PAIS.equals(valores[0])) {
    ...
    public static void main (String[] args) throws IOException, InterruptedException, ClassNotFoundException {
          ...
          String arquivoSaida = "/home2/ead2022/SEM1/lucas.francisconi/Desktop/atp/etapa2/informacao6";
          ...
          Job job = Job.getInstance(conf, "etapa02-atv06");
